...
const USER_CONFIG = {
  ...
  SLOT_LIST: [
    ...
    // 这样配置的话，就会每次随机选一句话发送
    {
      keyword: 'my_love',
      contents: [
        '不会吧，现在只有土包子才信星座，百度都说INTJ和ENFP绝配！',
        '刚查了，星座书上说ENFP的双鱼，今天会被一个INTJ的处女暗恋！是谁呢？',
        '这条只有十分之一的概率会出现，估计写在这里沸羊羊也不会发现，处女座偷偷表个白，爱你，kiss,kiss',
        '今日如果遇到处女座的男生，一定要留住他，别让他跑了',
        '听说今天早上双鱼猛亲处女五下会有好事发生哦～',
        '什么，沸羊羊今天这么棒！太厉害了吧！',
        '今天认真工作的双鱼座又变帅了',
        '看什么星座运势啊，看我看我，爸爸保佑你',
        '呦，刷手机呢，都不想我，可恶的沸羊羊',
        '想沸羊羊的下午，更新了这里的词条，可恶的沸羊羊都没有发现，今天就不祝福你了，哼',
      ],
    }
    // 你可以不断按格式往下增加
    // ...
